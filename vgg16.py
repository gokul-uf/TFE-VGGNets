...
class VGG16Net(tf.keras.Model):
    ...
    def __init__(self, num_classes):
        ...
        self.layer_8 = self.get_conv_layer(num_filters=512)
        ...
        self.layer_14 = tf.layers.Dense(units=4096, activation=tf.nn.relu)
        self.layer_15 = tf.layers.Dense(units=4096, activation=tf.nn.relu)
        self.layer_16 = tf.layers.Dense(
